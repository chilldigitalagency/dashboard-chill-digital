...
import { fetchDailyInsights, resolveMetaAccessToken } from "@/lib/meta-ads/client";
...
export async function GET(
  ...
  try {
    ...
    const data = await fetchDailyInsights(client.meta_account_id, resolveMetaAccessToken(client.meta_access_token), dateFilter);
